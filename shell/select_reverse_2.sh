...
grep -Evi 'AAAAAAAAAAAAAAAAAAAA|TTTTTTTTTTTTTTTTTTTT|GGGGGGGGGGGGGGGGGGGG|CCCCCCCCCCCCCCCCCCCC' output/rprobes.bed | awk -v OFS="\t" '{if ($10 >= 0.4 && $10 <= 0.7) print $0, 2}' | awk -F "\t" '!seen[$5, $6]++' > output/rtemp3.bed
